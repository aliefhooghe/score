...
class SCORE_PLUGIN_SCENARIO_EXPORT SynchronizationModel final
    : public score::Entity<SynchronizationModel>
{
  Q_OBJECT
...
public:
  ...
  SynchronizationModel(DeserializerVisitor&& vis, QObject* parent)
      : Entity{vis, parent}
  {
    vis.writeTo(*this);
  }
  ...
  SynchronizationModel(
      const SynchronizationModel& source,
      const Id<SynchronizationModel>& id,
      QObject* parent);

  // Data of the Synchronization
...
DEFAULT_MODEL_METADATA(Scenario::SynchronizationModel, "Sync")
TR_TEXT_METADATA(, Scenario::SynchronizationModel, PrettyName_k, "Sync")
