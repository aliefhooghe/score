...
static const constexpr int ClickOnSynchronization
    = ScenarioElement::Synchronization + score::Modifier::Click_tag::value;
...
static const constexpr int MoveOnSynchronization
    = ScenarioElement::Synchronization + score::Modifier::Move_tag::value;
...
static const constexpr int ReleaseOnSynchronization
    = ScenarioElement::Synchronization + score::Modifier::Release_tag::value;
...
using ClickOnSynchronization_Event
    = PositionedWithId_ScenarioEvent<SynchronizationModel, ClickOnSynchronization>;
...
using MoveOnSynchronization_Event
    = PositionedWithId_ScenarioEvent<SynchronizationModel, MoveOnSynchronization>;
...
using ReleaseOnSynchronization_Event
    = PositionedWithId_ScenarioEvent<SynchronizationModel, ReleaseOnSynchronization>;
...
QString debug_StateMachineIDs()
{
  ...
  switch (object)
  {
    case ScenarioElement::Nothing:
      txt += "nothing";
      break;
    case ScenarioElement::Synchronization:
      txt += "Sync";
      break;
